...
const isAuthenticated = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (refreshToken) {
      ...
      try {
        const decodeRefreshToken = jsonwebtoken_1.default.verify(
          refreshToken,
        ...
        yield db_1.db.user.update({
          ...
          data: {
            refreshToken:
              createToken === null || createToken === void 0 ? void 0 : createToken.refreshToken,
            accessToken:
              createToken === null || createToken === void 0 ? void 0 : createToken.accessToken,
          },
        });
